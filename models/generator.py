...
class Generator(pl.LightningModule):
    ...
    def __init__(self, args):
        ...
        if args.generator == 'EncoderForecaster':
            ...
            self.generator = AttnUNet(
                input_steps=args.input_steps, forecast_steps=args.forecast_steps
            )
    ...
    def configure_optimizers(self):
        optimizer = AdamW(self.generator.parameters(), lr=self.args.gen_lr,
    ...
    def training_step(self, batch, batch_idx) -> torch.Tensor:
        ...
        g_loss = losses.recon_loss(pred, truth) * self.args.recon_reg \
        ...
        if (batch_idx + 1) % self.args.log_interval == 0:
            print('Epoch: [{}][{}]  Batch: [{}][{}]  G Loss: {:.4f}'
                       .format(self.current_epoch + 1, self.total_epochs, batch_idx + 1, self.train_batch_num, g_loss))
    ...
    def validation_step(self, batch, batch_idx) -> torch.Tensor:
        ...
        if (batch_idx + 1) % self.args.log_interval == 0:
            print('Epoch: [{}][{}]  Batch: [{}][{}]  G Loss: {:.4f}'
                       .format(self.current_epoch + 1, self.total_epochs, batch_idx + 1, self.val_batch_num, g_loss))
    ...
    def training_epoch_end(self, outputs):
        ...
        visualizer.plot_loss(np.array(self.train_loss), np.array(self.val_loss),

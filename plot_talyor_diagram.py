...
if __name__ == '__main__':
    ...
    plot_taylor_diagram('results', 
                        ...
                        'test/taylor_ablation.jpg', std_range=[3, 18], std_num=6, 
                        colors=colors.colors)
    plot_taylor_diagram('results',
                        ['PySTEPS', 'Encoder_Forecaster', 'SmaAt_UNet', 'AttnUNet_GAN_CV'], 
                        ['PySTEPS', 'ConvLSTM-EF', 'SmaAt-UNet', 'AGAN+SVRE'],
                        'test/taylor_comparison.jpg', std_range=[3, 18], std_num=6, 
                        colors=colors.colors)

...
def concat_model_metrics(metrics: dict, idx: int):       
    metrics_60min = pd.concat(metrics.values())
    metrics_60min = metrics_60min.drop(columns=['Time', 
                                                'POD_20.0', 'FAR_20.0', 'CSI_20.0', 
...
def analyze_ablation_metrics():
    ...
    case_0_metrics = concat_model_metrics(case_0_metrics, 9)
    case_1_metrics = concat_model_metrics(case_1_metrics, 9)

...
def plot_psd_all(model_names, model_dirs):
    plot_psd(model_names, model_dirs, 'case_1', 'results/img/psd_case_1.png')
    plot_psd(model_names, model_dirs, 'case_2', 'results/img/psd_case_2.png')


def plot_taylor_diagram_all(model_names, model_dirs):
    plot_taylor_diagram(model_names, model_dirs, 'case_1', 'results/img/taylor_case_1.png')
    plot_taylor_diagram(model_names, model_dirs, 'case_2', 'results/img/taylor_case_2.png')


def plot_maps_all(model_names, model_dirs):
    plot_maps(model_names, model_dirs, 'case_1', 'results/img/vis_case_1.png')
    plot_maps(model_names, model_dirs, 'case_2', 'results/img/vis_case_2.png')


def plot_scatter_all(model_names, model_dirs):
    plot_scatter(model_names, model_dirs, 'case_1', 'results/img/scatter_case_1.png')
    plot_scatter(model_names, model_dirs, 'case_2', 'results/img/scatter_case_2.png')
